...
«Большая» конечная арифметика - это коммутативное кольцо с единицей $\langle Z_8^n; +, * \rangle$, элементами которого являются слова длины \(n\), составленные из символов
