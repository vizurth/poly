...
матрицу смежности и собирает все ещё не удалённые вершины без входящих дуг.
...
Счётчик итераций растёт при каждом просмотре ячейки матрицы~---
это нужно для сравнения трудоёмкости алгоритмов.
...
Сложность: $O(V^2)$, пространственная: $O(V)$.
