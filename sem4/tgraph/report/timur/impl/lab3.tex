...
\textbf{Вход:} \texttt{Graph<T> const\&}, \texttt{vector<vector<T>> costMatrix},
...
\subsubsection{Генерация матриц пропускных способностей и стоимости}

При генерации нового графа \texttt{Lab3UI::onNewGraph} берёт матрицу
пропускных способностей из весовой матрицы (по модулю) и генерирует
случайную матрицу стоимостей для рёбер через отдельный \texttt{Generator<int>}.
