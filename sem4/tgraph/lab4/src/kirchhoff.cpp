...
/*
    ...
    Реализуем алгоритм Барейсса для подсчёта детерминанта целочисленной матрицы
   Кирхгофа. Возвращаем абсолютное значение детерминанта, которое равно числу
   остовных деревьев. Сложность: O(n^3).
*/
long long Kirchhoff::count(const Graph<int> &g) {
	...
	// матрицу Кирхгофа строим на основе матрицы смежности
