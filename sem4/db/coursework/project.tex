...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|c Z Y C{2.2cm} c c c c|}
        ...
        7 & статус & current\_status & VARCHAR(30) & - & - & - & NOT NULL \\
        \hline
    \end{tabularx}
\end{table}

% --- Таблица 6: parking_session ---
\begin{table}[H]
