...
\begin{lstlisting}[style=sqlstyle, caption={SQL-скрипт для создания схемы базы данных}, label={lst:schema}]
...
\begin{lstlisting}[style=sqlstyle, caption={SQL-скрипт для создания индексов}, label={lst:schema}]
-- employee
