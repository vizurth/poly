...
Для выполнения простого запроса к созданному представлению был сформулирован запрос: вывести автомобили, которые парковались более чем в N разных зонах и имеют хотя бы два тревожных события.
...
Результат выполнения сложного запроса представлен на листинге~\ref{fig:hard_query_result}. В результате выполнения было выведено 19 автомобилей.
\begin{figure}[H]
    \centering
