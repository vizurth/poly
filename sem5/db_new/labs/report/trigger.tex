...
\subsubsection*{Таблица с описание атрибутов новой таблицы}
...
% --- Таблица 1: car_stats ---
\begin{table}[H]
    \caption{Статистика автомобилей -- car\_stats}
    \label{tab:car_stats}
    ...
    \begin{tabularx}{\textwidth}{|c Z Y C{2.2cm} c c c c|}
        \hline
        \multicolumn{8}{|c|}{\textbf{Статистика автомобилей -- car\_stats}} \\
        \hline
        № & Название RU & Название EN & Тип атрибута & Def & Тип ключа & Ссылка & Прим. \\
        \hline
        1 & авто\_id & car\_id & SERIAL & - & PK & - & NOT NULL \\
        2 & гос_номер & reg\_number & VARCHAR(30) & - & - & - & NOT NULL \\
        3 & кол-во событий & alert\_count & BIGINT & 0 & - & - & NOT NULL \\
        4 & кол-во парковок & parking\_count & BIGINT & 0 & - & - & NOT NULL \\
        \hline
    \end{tabularx}
\end{table}

\subsubsection*{Код создания таблицы}
...
\subsection{Графическое описание схемы базы данных}

Графическое описание схемы базы данных с новой таблицей и триггерами приведено на рисунке~\ref{fig:db-schema-triggers}.
...
\begin{landscape}
  ...
  \begin{figure}[!p]
    \centering
\includegraphics[width=\linewidth,height=\dimexpr\textheight-4\baselineskip\relax,keepaspectratio]{myPhoto/db_english.png}
